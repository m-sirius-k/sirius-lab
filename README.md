...
| Path | Description |
|------|-------------|
| `/` | Series overview and world view |
...
Every AI interaction should leave a verifiable trace.  
Every decision should be reproducible.  
Every failure should become institutional knowledge.
...
*"Work that leaves no record does not exist."*
